...
int main()
{
    ...
    cout<<"--------------------------------------------------------------------------\n"<<endl;
    cout<<"            MENU:"<<endl;
    cout<<"                    To Calculate GPA (Grade Point Average) Enter-(1) "<<endl;
    cout<<"                    To Calculate CGPA (Cummulative Grade Point Average) Enter-(2) "<<endl;
    cout<<"                    To Method that is applied here for calclating GPA & CGPA Enter-(3) "<<endl;
    cout<<"                    To Exit Application Enter-(4)"<<endl;
    cout<<"--------------------------------------------------------------------------"<<endl;
    sub:
...
void calculateGPA()
{
    ...
    for(int i=0;i<q;i++)
    {
        ...
        cout<<"Enter the Total Credit For subject-"<<i+1<<": ";
        cin>>credit[i];
        cout<<endl;
        cout<<"Enter the point Obtained in subject-"<<i+1<<": ";
        cin>>point[i];
        cout<<"\n"<<endl;
    }
